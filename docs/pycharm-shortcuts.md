...
mapped to their **native VSCode** equivalents. The recommendation here is *not* to
...
your *secondary* editor and PyCharm muscle memory dominates — otherwise prefer the
